                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-4 col-md-3">
                            ...
                            @if (!empty($errors->create->first('answer')))
                                <span class="text-danger alert " role="alert">{{ $errors->create->first('answer') }}</span>
                            @endif
                                <select class="selectpicker form-control" name="answer[]" id="answer[]"
                                    ...
                                    @for ($x = 0; $x < $numChoice; $x++)
                                        <option value="{{ $letters[$x] }}"
                                            @if (old('answer') == $letters[$x]) class="text-light font-weight-bold bg-primary" selected @endif>{{ $letters[$x] }}
                                        </option>
                                    @endfor
                                </select>
                                @if(!empty($errors->create->first('answer')))
                                    <span class="text-danger alert p-0 " role="alert">{{ $errors->create->first('answer') }}</span>
                                @endif
                        </div>
                        @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control text-capitalize "
                                                name="description[{{ $i }}][{{ $x }}]" id="Username"
